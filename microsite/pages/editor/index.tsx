...
const Editor: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Main content is centered at 60% width */}
      <main className="mx-auto w-[60%] py-8 flex flex-col">
        <h1 className="text-3xl font-bold text-center mb-8">Editor</h1>

        {/* IMAGE SELECTION */}
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 flex flex-wrap gap-4 justify-center">Select Images</h2>
        ...
        {/* TEXT SELECTION */}
        <section className="mb-10">
          <h2 className="text-xl font-semibold mb-4 flex flex-wrap gap-4 justify-center">Select Text Variants</h2>
